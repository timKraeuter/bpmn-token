...
export default function BpmnRenderer(
  ...
  function drawXonElement(parentGfx, element) {
  ...
  function tokenShouldNotExist(element) {
    return !getSemantic(element).shouldExist;
  }
  ...
  var handlers = (this.handlers = {
    ...
    "bt:Token": function (parentGfx, element) {
      // TODO: Token

      const textElement = drawCircle(
        parentGfx,
        element.width,
        element.height,
        0,
      ...
      if (tokenShouldNotExist(element)) {
        drawXonElement(parentGfx, element);
      }

      renderLabel(parentGfx, "1", {
        box: element,
        align: "center-middle",
        padding: 5,
        style: {
    ...
    "bt:ProcessSnapshot": function (parentGfx, element) {
      // TODO: ProcessSnapshot

      return drawCircle(parentGfx, element.width, element.height, 0, {
        fill: "#10D070",
        stroke: "none",
      });
    },
