...
import tokenModdle from "token-bpmn-moddle/resources/token.json";
 ...
 */
BaseViewer.prototype.importDefinitions = async function importDefinitions(
  definitions,
  bpmnDiagram,
) {
...
BaseViewer.prototype._createModdle = function (options) {
  const moddleOptions = assign(
    ...
    { token: tokenModdle }, // TODO: Do this in the starter using the options.
  );
