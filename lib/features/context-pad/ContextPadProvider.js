...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
  ...
  if (isAny(businessObject, ['bpmn:Lane', 'bpmn:Participant']) && isExpanded(
      element)) {
  ...
  if (is(businessObject, 'bpmn:FlowNode')) {
    ...
    if (is(businessObject, 'bpmn:EventBasedGateway')) {
    ...
    } else if (isEventType(businessObject, 'bpmn:BoundaryEvent',
      ...
      assign(actions, {
        ...
        !isEventType(businessObject, 'bpmn:IntermediateThrowEvent',
  ...
  // TODO: Move to its own context pad provider.
  if (isAny(businessObject, ['bpmn:Activity', 'bpmn:SequenceFlow'])) {
    console.log("Activity context;", businessObject);
    assign(actions, {
      'token': {
        group: 'edit',
        html: `<div class="entry">${ICONS['token']}</div>`,
        title: translate('Add token'),
        action: {
          click: removeElement // TODO: Add real action: Extend moddle or add as custom BPMN.
        }
      },
    });
  }
  if (is(businessObject, 'bpmn:Participant')) {
    assign(actions, {
      'process': {
        group: 'edit',
        html: `<div class="entry">${ICONS['process']}</div>`,
        title: translate('Add process'),
        action: {
          click: removeElement // TODO: Add real action: Extend moddle or add as custom BPMN.
        }
      },
