 ...
 * @param {Canvas} canvas
 */
export default function AlignElementsContextPadProvider(
  contextPad,
  popupMenu,
  translate,
  canvas,
 ...
 */
AlignElementsContextPadProvider.prototype.getMultiElementContextPadEntries =
  function (elements) {
    var actions = {};
...
AlignElementsContextPadProvider.prototype._getMenuPosition = function (
  elements,
) {
  var Y_OFFSET = 5;
