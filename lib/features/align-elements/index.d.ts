declare namespace _default {
  ...
  const alignElementsContextPadProvider: (
    | string
    | typeof AlignElementsContextPadProvider
  )[];
  const alignElementsMenuProvider: (
    | string
    | typeof AlignElementsMenuProvider
  )[];
  const bpmnAlignElements: (string | typeof BpmnAlignElements)[];
}
