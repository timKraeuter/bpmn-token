 ...
 */
BpmnUpdater.prototype.updateDiConnection = function (
  connection,
  newSource,
  newTarget,
) {
  ...
  if (
    connectionDi.sourceElement &&
    connectionDi.sourceElement.bpmnElement !== getBusinessObject(newSource)
  ) {
    connectionDi.sourceElement = newSource && newSourceDi;
  }

  if (
    connectionDi.targetElement &&
    connectionDi.targetElement.bpmnElement !== getBusinessObject(newTarget)
  ) {
...
BpmnUpdater.prototype.updateSemanticParent = function (
  ...
  if (is(businessObject, "bpmn:Lane")) {
    ...
    containment = is(businessObject, "bt:BaseToken") ? "values" : "artifacts";
    if (is(businessObject, "bt:BaseToken") && newParent) {
