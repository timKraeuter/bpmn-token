 ...
 */
export default function TokenElementColorBehavior(eventBus, modeling) {
...
inherits(TokenElementColorBehavior, CommandInterceptor);

TokenElementColorBehavior.$inject = ["eventBus", "modeling"];
