...
import DropTokenBehavior from "./DropTokenBehavior";
import TokenElementColorBehavior from "./TokenElementColorBehavior";
...
export default {
  ...
  dropTokenBehavior: ["type", DropTokenBehavior],
  tokenElementColorBehavior: ["type", TokenElementColorBehavior],
