 ...
 */
export default function TokenKeyboardBindings(injector) {
  injector.invoke(KeyboardBindings, this);
}

inherits(TokenKeyboardBindings, KeyboardBindings);

TokenKeyboardBindings.$inject = ["injector"];
 ...
 */
TokenKeyboardBindings.prototype.registerBindings = function (
  keyboard,
  editorActions,
) {
