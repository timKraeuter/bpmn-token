declare namespace _default {
  ...
  const gridSnappingAutoPlaceBehavior: (
    | string
    | typeof GridSnappingAutoPlaceBehavior
  )[];
  const gridSnappingParticipantBehavior: (
    | string
    | typeof GridSnappingParticipantBehavior
  )[];
  const gridSnappingLayoutConnectionBehavior: (
    | string
    | typeof GridSnappingLayoutConnectionBehavior
  )[];
}
