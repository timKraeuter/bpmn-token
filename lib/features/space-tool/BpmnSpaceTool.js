 ...
 * @return {Object}
 */
BpmnSpaceTool.prototype.calculateAdjustments = function (
  elements,
  axis,
  delta,
  start,
) {
  var adjustments = SpaceTool.prototype.calculateAdjustments.call(
    this,
    elements,
    axis,
    delta,
  ...
  adjustments.resizingShapes = adjustments.resizingShapes.filter(
    function (shape) {
