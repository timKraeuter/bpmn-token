...
function canStartConnection(element) {
  ...
  return isAny(element, [
    ...
    "bpmn:Group",
    "bpmn:TextAnnotation",
    "bpmn:TextAnnotation2", // TODO: Token
  ]);
}
...
function isTextAnnotation(element) {
  return isAny(element, ["bpmn:TextAnnotation", "bpmn:TextAnnotation2"]); // TODO: Token canConnectAssociation is important!
}
...
function canResize(shape, newBounds) {
  ...
  // TODO: Token could be different if isTextAnnotation returns false.
  if (is(shape, "bpmn:TextAnnotation2")) {
    return false;
  }
